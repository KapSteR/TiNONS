...
When doing speaker recognition it is advantageous to classify on the basis of extracted features from speech data, rather than the audio samples themselves. \ref{} \fxnote{ref til hvad?}% Reference
...
They have proven effective for use in speaker recognition, in other implementations. \ref{} \fxnote{ref til hvad? igen} % Reference
