...
\caption{Diagram of the two layer neural network. The nodes in the figure represents the input, hidden and output variable. The links between the nodes are the weight parameters. The figure is taken from \fxnote{ref til bishop}} 
...
The dataset that was used to make the    
The number numbers of hidden units found to be optimal is 30.
\section{Results}
