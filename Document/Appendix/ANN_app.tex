...
The basic neural network model, which is a series of functional transformations. \fxnote{What?}
...
\caption{Results of using ANN with 3 speakers, 30 hidden variables and 1 digit spoken} \fxnote{Figurtext?}
