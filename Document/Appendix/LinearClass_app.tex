...
The resulting vector is placed in a vector $\mathbf{t}_{est}$, which contains the classification and ranges over the three classes $\left\lbrace 1,2,3\right\rbrace $. show t estimate %\fixme
